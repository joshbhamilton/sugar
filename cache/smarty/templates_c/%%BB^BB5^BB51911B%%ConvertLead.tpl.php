...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/modules/Meetings/ConvertLead.tpl', 17, false),array('function', 'counter', 'cache/modules/Meetings/ConvertLead.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/modules/Meetings/ConvertLead.tpl', 72, false),array('function', 'html_options', 'cache/modules/Meetings/ConvertLead.tpl', 138, false),array('modifier', 'default', 'cache/modules/Meetings/ConvertLead.tpl', 34, false),array('modifier', 'strip_semicolon', 'cache/modules/Meetings/ConvertLead.tpl', 40, false),)), $this); ?>
...
<input class="checkbox" type="checkbox" name="newMeetings" id="newMeetings" onclick="toggleDisplay('createMeetings');">
...
" size="11" maxlength="10" title='' tabindex="133" onblur="combo_Meetingsdate_start.update(); " onchange="combo_Meetingsdate_start.update(); ">
...
" id="Meetingsdate_start_trigger" name="Meetingsdate_start_trigger" align="absmiddle">&nbsp;
</td>
<td nowrap>
...
<input tabindex="134"  name="Meetingsduration_hours" tabindex="1" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
" />
...
rows="10" 
cols="90" 
title='' tabindex="135" ><?php echo $this->_tpl_vars['value']; ?>
</textarea>
</td>
</tr>
</table><?php echo '

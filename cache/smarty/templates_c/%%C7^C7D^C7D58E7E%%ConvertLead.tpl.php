...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/modules/Calls/ConvertLead.tpl', 17, false),array('function', 'counter', 'cache/modules/Calls/ConvertLead.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/modules/Calls/ConvertLead.tpl', 72, false),array('function', 'html_options', 'cache/modules/Calls/ConvertLead.tpl', 138, false),array('modifier', 'default', 'cache/modules/Calls/ConvertLead.tpl', 34, false),array('modifier', 'strip_semicolon', 'cache/modules/Calls/ConvertLead.tpl', 40, false),)), $this); ?>
...
<input class="checkbox" type="checkbox" name="newCalls" id="newCalls" onclick="toggleDisplay('createCalls');">
...
" size="11" maxlength="10" title='' tabindex="129" onblur="combo_Callsdate_start.update(); " onchange="combo_Callsdate_start.update(); ">
...
" id="Callsdate_start_trigger" name="Callsdate_start_trigger" align="absmiddle">&nbsp;
</td>
<td nowrap>
...
<input tabindex="130"  name="Callsduration_hours" tabindex="1" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
"/>
...
rows="10" 
cols="90" 
title='' tabindex="131" ><?php echo $this->_tpl_vars['value']; ?>
</textarea>
</td>
</tr>
</table><?php echo '
<script type="text/javascript">
addToValidateBinaryDependency(\'ConvertLead\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Calls','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Calls','for_js' => true), $this); echo '\', \'assigned_user_id\' );
</script>'; ?>

...
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_translate', 'cache/modules/Notes/ConvertLead.tpl', 29, false),array('function', 'counter', 'cache/modules/Notes/ConvertLead.tpl', 43, false),array('modifier', 'default', 'cache/modules/Notes/ConvertLead.tpl', 33, false),array('modifier', 'strip_semicolon', 'cache/modules/Notes/ConvertLead.tpl', 39, false),)), $this); ?>
...
<input class="checkbox" type="checkbox" name="newNotes" id="newNotes" onclick="toggleDisplay('createNotes');">
...
rows="10" 
cols="90" 
title='' tabindex="127" ><?php echo $this->_tpl_vars['value']; ?>
</textarea>
</td>
...
<script type="text/javascript">
addToValidateBinaryDependency(\'ConvertLead\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'Notes','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'Notes','for_js' => true), $this); echo '\', \'assigned_user_id\' );
</script>'; ?>
